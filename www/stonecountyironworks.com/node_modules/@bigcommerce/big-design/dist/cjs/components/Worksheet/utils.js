...
const editedRows = (editedCells, rows) => editedCells.reduce((accum, _ref) => {
  let {
    rowIndex
  } = _ref;
...
const getHiddenRows = function (expandableRows) {
