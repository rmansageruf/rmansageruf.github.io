...
const StyledFlex = /*#__PURE__*/_styledComponents.default.div.withConfig({
  displayName: "styled__StyledFlex",
  componentId: "sc-yxkzj0-0"
})(["", " background-color:", ";display:flex;padding:", ";", ""], (0, _withFlex.withFlexedContainer)(), _ref => {
  let {
    theme
  } = _ref;
  ...
  return `${theme.spacing.small} ${theme.spacing.xLarge}`;
}, _ref3 => {
  let {
    theme,
    stickyHeader
